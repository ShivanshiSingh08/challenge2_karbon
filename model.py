...
def analyze_financial_data(data: dict):
    ...
    return [
        f"Rule 1: TOTAL REVENUE 5CR FLAG - {total_revenue_5cr_flag_value}",
        f"Rule 2: BORROWING TO REVENUE FLAG - {borrowing_to_revenue_flag_value}",
        f"Rule 3: ISCR FLAG - {iscr_flag_value}",
    ]
